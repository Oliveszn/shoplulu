                ...
                <li key={item.name} className="relative group">
                  {item.name === "SHOP" ? (
                    ...
                    >
                      ...
                      {isShopHovered && (
                        <>
                          <div className="dropdown-hover-buffer" />
                          <div
                            className={`fixed top-0 left-0 bottom-20 w-full transition-all bg-white duration-500 ease-in-out z-50 transform ${
                              isShopHovered
                          ...
                          >
                            <div className="relative top-6 p-6 bg-priColor rounded-xl shadow-xl ">
                                      ...
                                      >
                                        ...
                                        <ul className="cursor-pointer list-none">
                                          {subCategories.map((subCat) => (
                                            <li
                                              key={subCat.id}
                                              className="capitalize hover:text-gray-600 transition-colors duration-200 py-1"
                                              onClick={() =>
